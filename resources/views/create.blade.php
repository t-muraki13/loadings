<x-app-layout>
  <div class="container px-5 py-12 mx-auto">
    <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      ...
      <p class="leading-relaxed text-lg">新規登録</p>
      ...
      <form action="{{ route('store') }}" method="post">
        ...
        <table class="w-full bg-white">
          ...
          <tr>
            ...
            <td class="px-4 py-2 w-2/3 font-semibold text-base text-gray-700 bg-gray-100 border border-gray-700">
                <textarea name="remarks" id="remarks" class="w-full bg-gray-100 focus:outline-none focus:bg-white border border-none rounded-md px-3 py-2 mt-2"></textarea>
            </td>
          </tr>
          <tr>
            <th class="px-4 py-2 w-1/5 font-semibold text-base text-gray-700 bg-blue-100 border border-gray-700">
